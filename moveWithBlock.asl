+!carryBlock(X,Y) : step(_,TIME) & not position(_,_,TIME) <- .wait("+position(_,_,TIME)",10,Arg);!carryBlock(X,Y).
...
+!moveVerticalWithBlock(X,Y) : step(_,TIME) & not position(_,_,TIME) <- .wait("+position(_,_,TIME)",10,Arg);!moveVerticalWithBlock(X,Y).
...
+!moveHorizontalWithBlock(X,Y) : step(_,TIME) & not position(_,_,TIME) <- .wait("+position(_,_,TIME)",10,Arg);!moveHorizontalWithBlock(X,Y).
...
+!dodgeWithBlock(X,Y,Direction) : step(_,TIME) & not position(A,B,TIME) <- .wait("+position(_,_,TIME)",10,Arg); !dodgeWithBlock(X,Y,Direction).
