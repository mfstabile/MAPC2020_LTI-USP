+!goToPosition(X,Y) : step(_,TIME) & not position(_,_,TIME) <- .wait("+position(_,_,TIME)",100,Arg);!goToPosition(X,Y).
...
+!moveVertical(X,Y) : step(_,TIME) & not position(_,_,TIME) <- .wait("+position(_,_,TIME)",100,Arg);!moveVertical(X,Y).
...
+!moveHorizontal(X,Y) : step(_,TIME) & not position(_,_,TIME) <- .wait("+position(_,_,TIME)",100,Arg);!moveHorizontal(X,Y).
...
+!dodge(X,Y,Direction) : step(_,TIME) & not position(A,B,TIME) <- .wait("+position(_,_,TIME)",100,Arg); !dodge(X,Y,Direction).
